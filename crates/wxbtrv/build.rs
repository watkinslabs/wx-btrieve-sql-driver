fn main() {
    ...
    if target == "i686-pc-windows-gnu" {
        ...
        // Pass the .def file to the linker for our own DLL exports.
        println!("cargo:rustc-link-arg-cdylib={manifest_dir}/exports.def");
    }
    // Build-time configurable install paths.
    let config_dir =
